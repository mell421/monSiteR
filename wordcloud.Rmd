...
tm <- function(text){
  ...
  barplot(dtm_d[1:20,]$freq, las = 2, names.arg = dtm_d[1:20,]$word, col =brewer.pal(8, "Dark2"), main ="Top 20 accueil", ylab = "Word frequencies")
...
main <- function(){
  ...
  # Plot the most frequent words
  barplot(dtm_d[1:20,]$freq, las = 2, names.arg = dtm_d[1:20,]$word, col =brewer.pal(8, "Dark2"), main ="Top 20 sem", ylab = "Word frequencies")
