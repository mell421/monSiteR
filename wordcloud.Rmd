...
tm <- function(text){
  ...
  barplot(dtm_d[1:max,]$freq, las = 2, names.arg = dtm_d[1:max,]$word, col =brewer.pal(8, "Dark2"), main ="Top 30 accueil", ylab = "Word frequencies")
...
tm <- function(text){
  ...
  barplot(dtm_d[1:max,]$freq, las = 2, names.arg = dtm_d[1:max,]$word,
          col =brewer.pal(8, "Dark2"), main ="Top 30 en cours",
...
tm <- function(text){
  ...
  # Remove your own stop word
  # specify your custom stopwords as a character vector
  TextDoc <- tm_map(TextDoc, removeWords, c("conclu", "conclubis", "titre","the"))
  # Remove punctuations
  TextDoc <- tm_map(TextDoc, removePunctuation)
  # Eliminate extra white spaces
  TextDoc <- tm_map(TextDoc, stripWhitespace)
  ...
  # Plot the most frequent words
  barplot(dtm_d[1:max,]$freq, las = 2, names.arg = dtm_d[1:max,]$word,
          col =brewer.pal(8, "Dark2"), main ="Top 30 recent",
          ylab = "Word frequencies")
  ...
  # dev.print(device = png, file = "recent.png", width = 600)
}
...
tm <- function(text){
  ...
  # Plot the most frequent words
  barplot(dtm_d[1:max,]$freq, las = 2, names.arg = dtm_d[1:max,]$word,
          col =brewer.pal(8, "Dark2"), main ="Top 30 termine",
          ylab = "Word frequencies")
...
main <- function(){
  ...
  # Plot the most frequent words
  barplot(dtm_d[1:max,]$freq, las = 2, names.arg = dtm_d[1:max,]$word,
          col =brewer.pal(8, "Dark2"), main ="Top 30 copy",
          ylab = "Word frequencies")
...
main <- function(){
  ...
  # Plot the most frequent words
  barplot(dtm_d[1:max,]$freq, las = 2, names.arg = dtm_d[1:max,]$word,
          col =brewer.pal(8, "Dark2"), main ="Top 30 conclu",
          ylab = "Word frequencies")

  #generate word cloud
  # set.seed(1234)
  # wordcloud(words = dtm_d$word, freq = dtm_d$freq, min.freq = 1, max.words=200, random.order=FALSE, rot.per=0.35, colors=brewer.pal(8, "Dark2"))
...
main <- function(){
  ...
  # Plot the most frequent words
  barplot(dtm_d[1:max,]$freq, las = 2, names.arg = dtm_d[1:max,]$word,
          col =brewer.pal(8, "Dark2"), main ="Top 30 conclubis",
          ylab = "Word frequencies")
...
main <- function(){
  ...
  # Plot the most frequent words
  barplot(dtm_d[1:max,]$freq, las = 2, names.arg = dtm_d[1:max,]$word, col =brewer.pal(8, "Dark2"), main ="Top 30 sem", ylab = "Word frequencies")
...
main <- function(){
  ...
  # Plot the most frequent words
  barplot(dtm_d[1:max,]$freq, las = 2, names.arg = dtm_d[1:max,]$word,
          col =brewer.pal(8, "Dark2"), main ="Top 30 mois",
          ylab = "Word frequencies")
...
main <- function(){
  ...
  # Plot the most frequent words
  barplot(dtm_d[1:max,]$freq, las = 2, names.arg = dtm_d[1:max,]$word,
          col =brewer.pal(8, "Dark2"), main ="Top 30 resume",
          ylab = "Word frequencies")
