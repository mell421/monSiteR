...
tm <- function(text){
  ...
  wordcloud(words = dtm_d$word, freq = dtm_d$freq, min.freq = 1,max.words=150, random.order=FALSE, rot.per=0.35,colors=brewer.pal(8, "Dark2"))
    ...
    # wordcloud2(data = dtm_d, color = "random-light")
...
main <- function(){
  ...
  # Plot the most frequent words
  barplot(dtm_d[1:15,]$freq, las = 2, names.arg = dtm_d[1:15,]$word,
          col =brewer.pal(8, "Dark2"), main ="Top 15 conclu",
          ylab = "Word frequencies")
...
main <- function(){
  ...
  # Plot the most frequent words
  barplot(dtm_d[1:15,]$freq, las = 2, names.arg = dtm_d[1:15,]$word,
          col =brewer.pal(8, "Dark2"), main ="Top 15 conclubis",
          ylab = "Word frequencies")
...
main <- function(){
  ...
  # Plot the most frequent words
  barplot(dtm_d[1:15,]$freq, las = 2, names.arg = dtm_d[1:15,]$word,
          col =brewer.pal(8, "Dark2"), main ="Top 15 sem",
          ylab = "Word frequencies")
...
main <- function(){
  ...
  # Plot the most frequent words
  barplot(dtm_d[1:15,]$freq, las = 2, names.arg = dtm_d[1:15,]$word,
          col =brewer.pal(8, "Dark2"), main ="Top 15 mois",
          ylab = "Word frequencies")
