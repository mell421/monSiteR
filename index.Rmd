...
# CopyS <- data.frame()
  ...
  barplot(CopyS$occ.ECS, 
          ...
          ylim=c(0,max(CopyS$occ.ECS)*1.3))
  box()
  print("mois")
  barplot(CopyS$occ.ECM, 
          ...
          main ="Top mois",
          ylab = "Word frequencies",
          ylim=c(0,max(CopyS$occ.ECM)*1.3))
  box()
  print("recent")
  barplot(CopyS$occ.ECR, 
          ...
          main ="Top recent",
          ylab = "Word frequencies",
          ylim=c(0,max(CopyS$occ.ECR)*1.3))
  box()
  print("tout")
  barplot(CopyS$count, 
          las = 2, 
...
# CopyS <- data.frame()
  ...
  barplot(CopyS$occ.FINIS, 
          ...
          main ="Top semaine",
          ylab = "Word frequencies",
          ylim=c(0,max(CopyS$occ.FINIS)*1.3))
  box()
  print("mois")
  barplot(CopyS$occ.FINIM, 
          ...
          main ="Top mois",
          ylab = "Word frequencies",
          ylim=c(0,max(CopyS$occ.FINIM)*1.3))
  box()
  print("recent")
  barplot(CopyS$occ.FINIR, 
          ...
          main ="Top recent",
          ylab = "Word frequencies",
          ylim=c(0,max(CopyS$occ.FINIR)*1.3))
  box()
  print("tout")
  barplot(CopyS$count_1, 
          ...
          main ="Top all",
          ylab = "Word frequencies",
          ylim=c(0,max(CopyS$count_1)*1.3))
  box()
  print("---")
  barplot(t(as.matrix(CopyS[2:4])), 
          las = 2, 
